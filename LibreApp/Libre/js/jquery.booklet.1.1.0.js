...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//add overlays
	if(opts.overlays){
		overlayP = $('<div class="b-overlay b-overlay-prev b-prev" title="Pagina Anterior"></div>').appendTo(b);
		overlayN = $('<div class="b-overlay b-overlay-next b-next" title="Pagina Siguiente"></div>').appendTo(b);
	...
	//add tabs
	if(opts.tabs){
		tabP = $('<div class="b-tab b-tab-prev b-prev" title="Previous Page">Anterior</div>').appendTo(b);
		tabN = $('<div class="b-tab b-tab-next b-next" title="Next Page">Siguiente</div>').appendTo(b);
		tabs = b.find('.b-tab');
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function initPages(){		
		...
		if(opts.closed){
			$(empty).attr({'title':opts.closedFrontTitle || "begin", 'rel':opts.closedFrontChapter || "Inicio del Libro"}).prependTo(src);
			src.children().last().attr({'title':opts.closedBackTitle || "Fin", 'rel':opts.closedBackChapter || "Fin del Libro"});		
			src.append(empty);		
		}
