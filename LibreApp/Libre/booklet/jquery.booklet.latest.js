...
;(function ($) {
    ...
    $.fn.booklet.defaults = {
        ...
        nextControlText: 'Siguiente',                          // inline text for all 'next' controls
        previousControlText: 'Anterior',                      // inline text for all 'previous' controls
        nextControlTitle: 'Pagina Siguiente',                     // text for title attributes of all 'next' controls
        previousControlTitle: 'Pagina Anterior',                 // text for title attributes of all 'previous' controls
