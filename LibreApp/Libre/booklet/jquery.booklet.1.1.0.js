...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(opts.arrows){
		...
		//update ctrls for RTL direction
		if(opts.direction == 'RTL'){
			arrowN.html('<div>Anterior</div>').attr('title','Pagina Anterior');
			arrowP.html('<div>Siguiente</div>').attr('title','Pagina Siguiente');
		}
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function initPages(){		
		...
		if(opts.closed){
			$(empty).attr({'title':opts.closedFrontTitle || "Inicio", 'rel':opts.closedFrontChapter || "Inicio de el Libro"}).prependTo(src);
			src.children().last().attr({'title':opts.closedBackTitle || "Fin", 'rel':opts.closedBackChapter || "Fin de El Libro"});		
			src.append(empty);		
		}
